...
<div class="right" style="padding:0px 0px 0px 10px;">
	...
	<div class="table-responsive"
		...
		<table border="1" cellpadding="3" cellspacing="0"
			class="table table-bordered" id="customerTable"
			style=" background-color: white;border-radius: 5px;text-align:center;">
			<tr>
				<td class="col-md-1">客户编号</td>
...
<script type="text/javascript"
	src="${pageContext.request.contextPath }/statics/js/customerlist.js"></script>
