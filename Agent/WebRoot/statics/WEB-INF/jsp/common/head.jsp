		...
		<dl>
			<dt>
				<img
					...
					style="height: 50px;width: 50px;">&nbsp;&nbsp; <label>${user.userName
						...
						href="#" style="font-size: 2px">在线</a> </span> </label>
			</dt>
			<dd>代理商模块</dd>
			<ul>
				...
				<li><span class="glyphicon glyphicon-print" aria-hidden="true"></span><a
					href="${pageContext.request.contextPath }/ahent.html">代理商管理</a><span
					class="glyphicon glyphicon-menu-left" aria-hidden="true"></span></li>
				<div class="daili" style="display: none;">
					<p class="xiala" style="margin:0px 0px 5px 10px;">
						<input type="radio"><a href="#" style="font-weight:100;">银行卡管理</a>
					</p>
					<p class="xiala"
						style="margin:10px 0px 0px 10px;padding:0px 0px 5px 0px;">
						<input type="radio"><a href="#" style="font-weight:100;">地址管理</a>
					</p>
				</div>
			...
			<ul>
				...
				<li><span class="glyphicon glyphicon-th" aria-hidden="true"></span><a
					href="${pageContext.request.contextPath }/GiftList.html">礼品管理</a><span
					class="glyphicon glyphicon-menu-left" aria-hidden="true"></span></li>
				...
				<li><span class="glyphicon glyphicon-magnet" aria-hidden="true"></span><a
					href="${pageContext.request.contextPath }/feedblist.html">意见反馈</a><span
					class="glyphicon glyphicon-menu-left" aria-hidden="true"></span></li>
				<li><span class="glyphicon glyphicon-th" aria-hidden="true"></span><a
