...
<html>
  <head>
	...
	-->
	<link rel="shortcut icon" href=" ${pageContext.request.contextPath }/statics/img/qqico.ico" />
	<link rel="stylesheet" href="${pageContext.request.contextPath }/statics/css/bootstrap.min.css" />
<link rel="stylesheet" href="${pageContext.request.contextPath }/statics/css/fukuan.css" />
  </head>
  ...
  <body>
    <div id="content">
			...
			<div class="daohang col-md-2">
				<span class="state">所有订单</span>
			     <span class="da" >|</span>
			</div>
			<div class="daohang col-md-2">
				<span class="state">待付款</span>
			     <span class="da">|</span>
			</div><div class="daohang col-md-2">
			...
			<button style="font-size: 1em;" type="button" ><span id="ji">交易状态</span> <span class="caret" id="san"></span></button>
    <div style="height: 270px;line-height: 30px;width: 100px;border-radius: 5px;" id="dw">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
		...
		<script type="text/javascript" src="${pageContext.request.contextPath }/statics/js/jquery-rotate-min.js"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath }/statics/js/fukuan.js"></script>
